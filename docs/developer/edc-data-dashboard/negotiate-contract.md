...
Asset Negotiation in EDC is an operation by which a Consumer connector, having obtained a Contract Offer from a Provider connector, negotiates a Contract Agreement with the Provider. The Contract Agreement  can afterwards be executed to have the Provider transfer data to the Consumer.
